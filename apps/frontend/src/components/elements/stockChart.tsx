...
//     const volatility =
//       stock.aiRecommendation.status === StockRecommendation.EXIT
//         ? 0.03
...
//     const days = 30;
//     let currentPrice = basePrice * (1 - (stock.priceChange / 100) * 5); // Start lower if positive trend
...
//   const isPositive = stock.volume >= 0;
